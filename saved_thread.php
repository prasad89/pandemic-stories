    ...
    <main role="main" class="flex-shrink-0">
        <div class="container">
            <div class="row">
                <!-- Saved Threads -->
                <div class="col-sm-8">
                    <h3 class="text-center text-muted mt-3">List of threads, You've saved!</h3>
                    <?php
                    $sql = "SELECT `th_id`,`th_title`,`th_description` FROM `threads` WHERE `th_id` in (SELECT `th_id` FROM `bookmarks` WHERE `u_id`=$userid)";
